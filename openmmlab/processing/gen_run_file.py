...
if __name__ == "__main__":
    ...
    run_files_root = 'openmmlab/run_files'
    key1 = 'deeplabv3plus'
    key2 = 'r50'
    key3 = 'cityscapes'
    key4 = ''
    ...
    with_cp = "GPUS=8 GPUS_PER_NODE=8 CPUS_PER_TASK=1 tools/slurm_train.sh mediaf mmseg {} --work-dir='./openmmlab/work_dirs'  --seed=0 --options model.backbone.with_cp=True"
    without_cp = "GPUS=8 GPUS_PER_NODE=8 CPUS_PER_TASK=1 tools/slurm_train.sh mediaf mmseg {} --work-dir='./openmmlab/work_dirs'  --seed=0"
